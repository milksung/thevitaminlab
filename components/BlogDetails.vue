      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="blog-details__main">
            ...
            <div class="blog-details__meta">
              <div class="blog-details__tags">
                <span>Tags: </span> <a href="#">Construction,</a>
                <a href="#">Build,</a> <a href="#">Factory</a>
              </div>
              <!-- /.blog-details__tags -->
          ...
          <div class="comment-one">
            <h3 class="comment-one__block-title">2 Comments</h3>
            ...
            <div class="comment-one__single">
              ...
              <div class="comment-one__content">
                <h3>
                  Kevin Martin
                  <span class="comment-one__date">20 April, 2020</span>
                </h3>
              ...
              <div class="blog-btn">
                <a href="#" class="main-btn main-btn-2"
                  >Reply <i class="flaticon-right-arrow"></i
                ></a>
              </div>
          ...
          <div class="comment-form">
            <h3 class="comment-one__block-title">Leave a Comment</h3>
            <!-- /.comment-one__block-title -->
            ...
            <div class="sidebar__single sidebar__category">
              ...
              <ul class="sidebar__category-list">
                <li class="sidebar__category-list-item">
                  <a href="#">Business <i class="fa fa-angle-right"></i></a>
                </li>
                <li class="sidebar__category-list-item">
                  <a href="#">Coworking <i class="fa fa-angle-right"></i></a>
                </li>
                <li class="sidebar__category-list-item">
                  <a href="#">Freelancers <i class="fa fa-angle-right"></i></a>
                </li>
                <li class="sidebar__category-list-item">
                  <a href="#"
                    >Creative people <i class="fa fa-angle-right"></i
                  ></a>
                </li>
                <li class="sidebar__category-list-item">
                ...
                <li class="sidebar__category-list-item">
                  <a href="#">Startups <i class="fa fa-angle-right"></i></a>
                </li>
              </ul>
                ...
                <div class="sidebar__post__single">
                  ...
                  <div class="sidebar__post-content">
                    <h4 class="sidebar__post-title">
                      <nuxt-link to="/single-post"
                        >Why your business absolutely needs a virtual
                        office</nuxt-link
                      >
                    </h4>
                    <!-- /.sidebar__post-title -->
