                ...
                <ul>
                  <li>
                    <a href="mailto:needhelp@codesk.com"
                      ><i class="flaticon-message"></i> needhelp@codesk.com</a
                    >
                  </li>
                  <li>
                    <a href="tel:7778880000"
                      ><i class="flaticon-phone-call"></i> 777 888 0000</a
                    >
                  </li>
                  <li>
                    <a href="#"
                      ><i class="flaticon-placeholder"></i> 20 Broklyn Street,
                      New York. USA</a
                    >
                  </li>
                </ul>
      ...
      <div :class="`main-header ${sticky ? 'sticky' : ''}`">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <div
                class="main-header-item d-flex d-lg-block justify-content-between align-items-center"
              >
