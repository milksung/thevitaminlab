      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="single-services mt-30 active">
            ...
            <nuxt-link to="/single-product"
              ><h4 class="title">High speed internet</h4></nuxt-link
            >
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="single-services mt-30">
            ...
            <nuxt-link to="/single-product"
              ><h4 class="title">Fully equipped kitchen</h4></nuxt-link
            >
            <p>There are many new variations of pasages of available text.</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="single-services mt-30">
            ...
            <nuxt-link to="/single-product"
              ><h4 class="title">Huge parking space</h4></nuxt-link
            >
            <p>There are many new variations of pasages of available text.</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="single-services mt-30">
            ...
            <nuxt-link to="/single-product"
              ><h4 class="title">Conference rooms</h4></nuxt-link
            >
            <p>There are many new variations of pasages of available text.</p>
          </div>
        </div>
